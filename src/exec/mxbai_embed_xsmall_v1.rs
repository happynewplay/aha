...
use crate::models::{LoadSpec, mxbai_embed_xsmall_v1::generate::MxbaiEmbedXsmallV1Model};
use crate::utils::get_file_path;

pub struct MxbaiEmbedXsmallV1Exec;

impl MxbaiEmbedXsmallV1Exec {
...
impl ExecModel for MxbaiEmbedXsmallV1Exec {
    fn run(input: &[String], output: Option<&str>, weight_path: &str) -> Result<()> {
        let spec =
            LoadSpec::for_safetensors(crate::models::WhichModel::MxbaiEmbedXsmallV1, weight_path);
